...
//	private static int			mOriRevValue		= -1;

	
	public static boolean isTablet(Context context) {
		boolean ret = true;
		// XXX 관심종목 가로보기 모드 제거됨
//		if (isHighResolution(context) || CLog.mUseLogSetting) {
//			ret = true;
//		}
		return ret;
	}

//	public static int getOrientationRevisionValue(Context context, int orientation) {
//		if (mOriRevValue == -1) {
//			if (isEnableLandMode(context)) {
//				mOriRevValue = -90;
//			} else {
//				mOriRevValue = 0;
//			}
...
//		}
//
////		CLog.i(TAG, "orientation="+orientation);
//
//		return orientation;
//	}
...
//		textViewWidth -= (textView.getPaddingLeft() + textView.getPaddingRight() + textView.getCompoundPaddingLeft() + textView.getCompoundPaddingRight());
//
