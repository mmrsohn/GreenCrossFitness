 ...
 */
public class Logger {
	private static final String	TAG				= "ShowPing";
	...
	public static void initLogger(Context context) {
		...
		if(mSavePath == null) {
			...
			if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
				...
				//saveDir = Environment.getDataDirectory().toString() + "/data/" + context.getPackageName();
...
//			sBuilder.append(DateForm.format(new Date()) + "\t");
//			sBuilder.append(priorityStr + "\t");
//			sBuilder.append(tag + "\t");
//			sBuilder.append(msg + "\r\n");
//
		// TODO 차후 적용 예정
//			try {
//				CrashLogger.footPrint(sBuilder.toString());
